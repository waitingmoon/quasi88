...
static	void	help_mess( void )
{
  ...
  (
   ...
   "    -nomouse/-mouse/       - Select mouse/joystick port setting [-nomouse]\n"
   "        -joymouse/-joystick               (also see -use_joy option )\n"
   ...
   "    -fullscreen/-window    - Start in Full-screen/Windowed [-window]\n"
   ...
   "    -cursor                - Convert from cursor-key to ten-key 2,4,6,8\n"
   ...
   "    -joyassign <0|1|2|3|4> - Key Asssign of joystick button [0]\n"
   ...
   "    -cmdkey/-nocmdkey      - Command key to menu (MacOS Classic only) [-cmdkey]\n"
   "  ** MENU **\n"
   "    -menu                  - start in menu mode\n"
   "    -japanese/-english     - Menu mode language is Japanese/English\n"
   "    -euc/-sjis             - filename decoding is EUC-japan/Shift JIS\n"
   "    -bmp/-ppm/-raw         - Screen snapshot file format [-bmp]\n"
   "    -swapdrv               - Change display position of Menu-Disk-screen\n"
   "  ** MISC **\n"
   ...
   "    -diskimage <filename>  - Set disk-image-file\n"
#ifdef	USE_MONITOR
