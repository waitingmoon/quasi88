...
#if 1	/* forQUASI88 */
				DELTAT->limit += (1 << (DELTAT->portshift-DELTAT->DRAMportshift) ) - 1;
#endif	/* forQUASI88 */
			}
		}
		DELTAT->control2 = v;
...
#if 1	/* QUASI88 */
			else if ( DELTAT->now_addr == (DELTAT->limit<<1) )
				DELTAT->now_addr = 0;
#endif
...
#else		/* forQUASI88 */
	*(DELTAT->pan) += (DELTAT->adpcml* adpcmvol / 100 );
#endif		/* forQUASI88 */
}
