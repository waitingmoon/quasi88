...
option_table[] =
{
  ...
  {   0, "cmdkey",       X_INV,                                       0,0,0,0},
  {   0, "nocmdkey",     X_INV,                                       0,0,0,0},
  ...
  { 201, "cmap",         X_INT,  &colormap_type,   -1, 2,                   0},
#ifdef MITSHM
  { 202, "shm",          X_FIX,  &use_SHM,         TRUE ,                 0,0},
  { 202, "noshm",        X_FIX,  &use_SHM,         FALSE,                 0,0},
#else
  {   0, "shm",          X_INV,                                       0,0,0,0},
  {   0, "noshm",        X_INV,                                       0,0,0,0},
#endif
  { 203, "xdnd",         X_FIX,  &use_xdnd,        TRUE ,                 0,0},
  { 203, "noxdnd",       X_FIX,  &use_xdnd,        FALSE,                 0,0},

  {   0, "hwsurface",    X_INV,                                       0,0,0,0},
  {   0, "swsurface",    X_INV,                                       0,0,0,0},
  {   0, "doublebuf",    X_INV,                                       0,0,0,0},
  {   0, "nodoublebuf",  X_INV,                                       0,0,0,0},
  {   0, "menucursor",   X_INV,                                       0,0,0,0},
  {   0, "nomenucursor", X_INV,                                       0,0,0,0},
